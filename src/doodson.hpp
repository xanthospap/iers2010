 ...
 *
 * 4. Balidakis, K., Sulzbach, R., Shihora, L., Dahle, C., Dill, R., & 
 ...
 */
constexpr static std::array<detail::TidalConstituentsArrayEntry,16> AtmosphericTidalHarmonics = {{
{/*162.556*/DoodsonConstituent(1, 1,-3, 0, 0, 1,-1.0e+00), 14.917866090000,0.00,"π1"},
{/*163.555*/DoodsonConstituent(1, 1,-2, 0, 0, 0,-1.0e+00), 14.958932770000,0.00,"P1"},
//{/*164.556*/DoodsonConstituent(1, 1,-1, 0, 0, 1,+1.0e+00), 15.000001410000,0.00,"S1"},
{/*164.555*/DoodsonConstituent(1, 1,-1, 0, 0, 0,+1.0e+00), 15.000001410000,0.00,"S1"},
{/*165.555*/DoodsonConstituent(1, 1, 0, 0, 0, 0,+1.0e+00), 15.041070050000,0.00,"K1"},
{/*166.554*/DoodsonConstituent(1, 1, 1, 0, 0,-1,+1.0e+00), 15.082136730000,0.00,"ψ1"},
{/*255.555*/DoodsonConstituent(2, 0, 0, 0, 0, 0,+0.0e+00), 28.984107050000,0.00,"M2"},
{/*272.556*/DoodsonConstituent(2, 2,-3, 0, 0, 1,+0.0e+00), 29.958936140000,0.00,"T2"},
{/*273.555*/DoodsonConstituent(2, 2,-2, 0, 0, 0,-1.0e+00), 30.000002820000,0.00,"S2"},
{/*274.554*/DoodsonConstituent(2, 2,-1, 0, 0,-1,+2.0e+00), 30.041069500000,0.00,"R2"},
{/*275.555*/DoodsonConstituent(2, 2, 0, 0, 0, 0,+0.0e+00), 30.082140100000,0.00,"K2"},
{/*381.555*/DoodsonConstituent(3, 3,-4, 0, 0, 0,+0.0e+00), 44.958935590000,0.00,"T3"},
{/*382.555*/DoodsonConstituent(3, 3,-3, 0, 0, 0,+2.0e+00), 45.000004230000,0.00,"S3"},
{/*383.555*/DoodsonConstituent(3, 3,-2, 0, 0, 0,+0.0e+00), 45.041072870000,0.00,"R3"},
{/*491.555*/DoodsonConstituent(4, 4,-4, 0, 0, 0,+0.0e+00), 60.000005640000,0.00,"S4"},
{/*5100.555*/DoodsonConstituent(5, 5,-5, 0, 0, 0,+0.0e+00), 75.000007050000,0.00,"S5"},
{/*611-1.555*/DoodsonConstituent(6, 6,-6, 0, 0, 0,+0.0e+00), 90.000008460000,0.00,"S6"}
}};
