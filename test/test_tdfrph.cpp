...
int main() {
  ...
  auto t1 = ngpt::datetime<ngpt::seconds>{ngpt::year(2009), ngpt::day_of_year(176)};
  auto t2 = ngpt::datetime<ngpt::seconds>{ngpt::year(2009), ngpt::day_of_year(176),
                                     ngpt::hours(12), ngpt::minutes(1),
                                     ngpt::seconds(45)};
