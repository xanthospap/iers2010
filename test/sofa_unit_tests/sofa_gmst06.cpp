...
//
// test accuracy of (this) gmst06 against the original, SOFA implementation
//
// WARNING!!
...
int main() {
  ...
  for (int t=0; t<num_tests; t++) {
    ...
    const double g06a1 = iers2010::sofa::gmst06(dso::mjd0_jd, mjd_ut1, dso::mjd0_jd, mjd_tt);

    // call SOFA
    const double g06a2 = iauGmst06(dso::mjd0_jd, mjd_ut1, dso::mjd0_jd, mjd_tt);
  ...
  printf("Checking SOFA and *this implementation of GMST06 function. Diffs:\n");
