...
const double input2[] = {
    1112189.660e0,       -4842955.026e0,     3985352.284e0,
...
const double input3[] = {
    1112200.5696e0,      -4842957.8511e0,     3985345.9122e0,
...
int main() {
  ...
  for (const auto &test : tests) {
    ...
    iers2010::dehanttideinel(test.second.xsta(), test.second.xsun(),
                             test.second.xmon(), test.second.t_, res);
    for (int i = 0; i < 3; ++i) {
#ifdef STRICT_TEST
