...
/// band.
void st1idiu(const double *, const double *, const double *, double, double,
             double *) noexcept;

/// Out-of-phase corrections induced by mantle anelasticity in the
/// semi-diurnal band.
void st1isem(const double *, const double *, const double *, double, double,
             double *) noexcept;

/// Corrections induced by the latitude dependence given by L^1 in
/// Mathews et al. 1991.
void st1l1(const double *, const double *, const double *, double, double,
           double *) noexcept;

/// In-phase and out-of-phase corrections induced by mantle anelasticity
/// in the diurnal band.
void step2diu(const double *, double, double, double *) noexcept;

/// In-phase and out-of-phase corrections induced by mantle anelasticity
/// in the long period band.
void step2lon(const double *, double, double *) noexcept;
...
inline double sprod(const double *x, const double *y, double &r1,
                    double &r2) noexcept {
