...
int main(int argc, char *argv[]) {
  if (argc != 5) {
    fprintf(
        stderr,
        "Usage: %s [00orbit_icrf.txt] [03directTideSun_icrf.txt] [de421.bsp] [naif*.tls]\n",
        argv[0]);
    return 1;
  }
  ...
  //} else {
  //  printf("#title Direct Tide Sun (ephermeris: %s)\n", basename(argv[3]));
  //}
